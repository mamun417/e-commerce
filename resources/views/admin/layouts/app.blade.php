...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('panel/assets/plugins/toastr/toastr.min.css') }}">
            ...
            <ul class="header_menu">
                <li><a href="#" class="search_btn" data-toggle="modal" data-target="#myModal"><i
                    ...
                    <div class="modal fade search_box" id="myModal">
                        <button type="button" class="close m-2 text-white float-right" data-dismiss="modal">&times;
                        </button>
...
<!--toastr-->
<script src="{{ asset('panel/assets/plugins/toastr/toastr.min.js') }}"></script>
