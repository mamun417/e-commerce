                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form class="form-horizontal" method="POST" action="{{ route('admin.password.update') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <span class="help-block m-b-none text-danger">
                                        @if(session('olderror')){{ session('olderror') }}@endif
                                    </span>
                            ...
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Password<span
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @error('password') <span
                                        class="help-block m-b-none text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-2 control-label">Confirm Password<span
                                        class="required-star"> *</span></label>
                                <div class="col-lg-6">
